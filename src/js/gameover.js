(function() {
  ...
  Gameover.prototype = {
    ...
    create: function () {
      ...
      this.restartButton = this.add.button(this.world.centerX, 300, 'restartButton', function(){this.game.state.start('game');}, this);
      ...
      this.menuButton = this.add.button(this.world.centerX, 500, 'menuButton', function(){this.game.state.start('menu');}, this);
